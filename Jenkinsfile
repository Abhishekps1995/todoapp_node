    ...
    stages{
        ...
        stage('Deploy with Docker Compose') {
            steps {
                ...
                sh "sudo scp -o StrictHostKeyChecking=no -i /home/ubuntu/ec2_micro_keypair.pem /home/ubuntu/todoapp_node/docker-compose.yml ubuntu@35.154.118.175:/home/ubuntu/docker-compose.yml"
